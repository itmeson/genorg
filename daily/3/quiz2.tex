...
\question Using the periodic table entry for Strontium (Sr), fill in the
...
\question Fill in a shell diagram for a Silicon atom.
  \begin{parts}
    ...
    \part If Si had a full outer shell, what would the overall charge be?
 \end{parts}
